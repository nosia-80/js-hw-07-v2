...
Обрати внимание на то, что изображение обёрнуто в ссылку, а значит при клике по
...
[SimpleLightbox](https://simplelightbox.com/), которая возьмёт на себя обработку
